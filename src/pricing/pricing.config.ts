  ...
  rules: {
    weekday: {
      per_person_tiers: [
        ...
        { hours_from: 3, hours_to: 4, price_cents_per_person: 200_00 },
        { hours_from: 4, hours_to: 5, price_cents_per_person: 250_00 },
        { hours_from: 5, hours_to: null, price_cents_per_person: 300_00 },
      ],
      ...
      teaching: {
        min_people: 8,
        base_hours: 3,
        base_price_cents_per_person: 300_00,
    ...
    holiday: {
      per_person_tiers: [
        ...
        { hours_from: 5, hours_to: 6, price_cents_per_person: 350_00 },
        { hours_from: 6, hours_to: null, price_cents_per_person: 400_00 },
      ],
      round_up_to_minutes: 60,
